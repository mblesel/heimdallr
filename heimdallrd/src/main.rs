...
struct Job2
{
    ...
    // mutexes: Mutex<HashMap<String, HeimdallrDaemonMutex2>>
}
...
fn handle_client(mut stream: TcpStream, job: Arc<Job2>, thread_barrier: Arc<Barrier>)
{
    ...
    loop
    {
        ...
        match pkt.pkt
        {
            ...
            {
                // TODO
                println!("MutexCreationPkt received");
            },
            DaemonPktType::MutexLockReq(mutex_pkt) =>
            {
                // TODO
                println!("MutexLockReqPkt received");
            },
            DaemonPktType::MutexWriteAndRelease(mutex_pkt) =>
            {
                // TODO
                println!("MutexWriteAndReleasePkt received");
            },
            DaemonPktType::Barrier(barrier_pkt) =>
            {
